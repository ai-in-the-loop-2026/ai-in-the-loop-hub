...
1. Define what tools are available
2. Execute them when requested
...
## Safe tool calling (before execution)
...
## Evaluating tool results (after execution)
...
3. **Validate inputs** — sandbox execution, check what the model asks to run
4. **Validate outputs** — check for sensitive data and hallucinations
5. **Log everything** — tool calls are important for debugging
