...
tags: [python, api, gemini, langraph, code-assist]
---
...
```bash
pip install google-genai langgraph python-dotenv
```
...
This is how we build applications that use AI!

---

## Our stack: Python + LangGraph + Gemini

- **Python:** The programming language
- **LangGraph:** Framework for building LLM applications with state and control flow
...
<!-- IMAGE: ![](images/03-stack-diagram.png){width=70%}
     ...
     PROMPT FOR NANO BANANA PRO: Create a layered stack diagram with 3 layers. Bottom layer:
     "Python" with Python logo. Middle layer: "LangGraph" (framework for LLM apps). Top layer:
     "Gemini API" with a cloud icon. Draw arrows showing how they connect - Python provides
     the foundation, LangGraph structures the app, Gemini provides the AI. Use clean boxes
...
- Use it during red-light assessments
...
- Complete **A1** using the GitHub Classroom Workflow
