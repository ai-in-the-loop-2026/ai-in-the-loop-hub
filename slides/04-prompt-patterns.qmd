...
# Step 1: Summarize
summary = generate(f"Summarize this article: {article}")

# Step 2: Extract key points
points = generate(f"List 3 key points from: {summary}")

# Step 3: Generate questions
questions = generate(f"Create quiz questions about: {points}")
```
