...
- Show per-node progress with `stream()`
...
::: {style="border: 2px solid #ccc; border-radius: 6px; display: inline-block; padding: 4px;"}
![](images/09-paper-analyzer-ui.png)
:::

<!-- IMAGE: ![](images/09-paper-analyzer-ui.png)
...
## Full Example 2: Setup and streaming
